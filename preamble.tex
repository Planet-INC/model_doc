...
\newcommand{\makeno@graph}{\make@@graph{\relax}}%
\newcommand{\make@graph}[1]{\makebox[0pt][r]{\raisebox{-1in}[0pt][0pt]{#1}}}%
\newcommand{\make@@graph}[1]{\ifx#1\relax
                                \renewcommand{\makegraph}{\make@graph{\rule{1ex}{0pt}}}%
                                \else
                                \renewcommand{\makegraph}{\make@graph{\includegraphics[width=0.9in]{#1}\rule{1ex}{0pt}}}%
                              \fi
                            }%
\renewcommand{\thesection}{\protect\makegraph\arabic{chapter}.\arabic{section}}
