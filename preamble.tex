...
\newcommand{\nomakegraph}{{\renewcommand{\makegraph}{\relax}}}%
\newcommand{\make@graph}[1]{\makebox[0pt][r]{\raisebox{-1in}[0pt][0pt]{\includegraphics[width=0.9in]{#1}\rule{1ex}{0pt}}}}%}
...
\renewcommand\section[1][\relax]{\ifx#1\relax%
                                  \nomakegraph%
                                 \else%
                                  \renewcommand{\makegraph}{\make@graph{#1}}
                                 \fi%
