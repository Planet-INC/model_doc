...
\draw[partof] (neucomp) -- (neureac) -- (neukineval)
              (ioncomp) -- (ionreac) -- (ionkineval);
\draw[partof,notconsidered]
                                        (neukineval) -- (kin)
                                        (ionkineval) -- (kin)
              (chap)    -- (hvtau)   -- (hvfeval)
...
\pgfresetboundingbox
\useasboundingbox (ant.south west) -- (ant.south east) -- (ant.north east) -- (ant.north west) -- cycle;
\end{tikzpicture}
\end{document}
