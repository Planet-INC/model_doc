...
\geometry{
paperwidth=11cm,paperheight=6.8cm,
...
\addplot[black,smooth,very thin,mark=none,domain=80:700,samples=20]{\A*1e-5*x^\s};

\foreach \D in {0.1892}
\addplot[red,smooth,very thin,mark=none,domain=80:700,samples=20]{\D*(x/273.15)^1.81};
\end{axis}
\end{tikzpicture}
\end{document}
