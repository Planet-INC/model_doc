...
\geometry{
paperwidth=3cm,paperheight=4cm,
...
\draw[partof,notconsidered] (neucomp) -- (neureac) -- (neukineval) -- (kin)
              (ioncomp) -- (ionreac) -- (ionkineval) -- (kin)
                          (bindiff) -- (moldiff)    -- (diff)
                                       (eddy)       -- (diff);
\draw[partof] (chap)    -- (hvtau)   -- (hvfeval);
...
\node[notconsidered,fit= (neucomp) (ioncomp) (neukineval) (ionkineval),rounded corners=1cm,inner sep=5pt,fill=gray!30] {\null};
...
\pgfresetboundingbox
\useasboundingbox (hvfeval.south west) -- (hvfeval.south east) |- (chap.north west) -| (hvfeval.south west);
\end{tikzpicture}%
-------
\end{document}
