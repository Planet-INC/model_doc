...
\begin{equationCode}{MolecularDiffusionEvaluator}
\begin{split}
\doverd{\diff_s}{T} & = \frac{\diff_s}{T} \frac{\displaystyle\sum_{j_m \neq s} \frac{\conc_{j_m}}{\diff_{j_m,s}}(\smas{j_m,s} - 1)}
                                     {\displaystyle\sum_{j_m \neq s} \frac{\conc_{j_m}}{\diff_{j_m,s}}}  \\[5pt]
\uu \frac{[cm^2\,s^{-1}]}{[K]} & \uu = \frac{[cm^2\,s^{-1}]}{[K]} \frac{\displaystyle\sum_{j_m \neq s}\frac{[cm^{-3}]}{[cm^2\,s^{-1}]}([-] - [-])}
                                                                       {\displaystyle\sum_{j_m \neq s}\frac{[cm^{-3}]}{[cm^2\,s^{-1}]}}
\end{split}
\label{Titan:Ds_dT}
\end{equationCode}
...
\doverd{\tilde{\diff_s}}{\conc_k} & = \tilde{\diff_s}\Bigg[
                                        \underbrace{\frac{1}{\concAtm - \conc_s}}_{\text{if } s \neq k}  - \frac{1}{\concAtm} 
