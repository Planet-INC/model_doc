...
\begin{equationCode}{BinaryDiffusion}
\begin{split}
\doverd{\diff_{s,m}}{\conc_k}      & = - \diff_{s,m}(T,P)\frac{1}{\concAtm}\\
\uu \frac{[cm^2\,s^{-1}]}{[cm^{-3}]} & \uu = [cm^{-2}\,s^{-1}]\frac{[cm^{-3}]}{[cm^{-3}]^2}\\ 
\end{split}
...
\begin{equationCode}{BinaryDiffusion}
\begin{split}
\doverd{\diff_{s,m}}{T}       & =   \diff_{s,m}(T,P)\frac{\smas{s,m} - 1}{T}\\
...
\begin{equationCode}{MolecularDiffusionEvaluator}
\begin{split}
\doverd{\diff_s}{\conc_k} & = \diff_s\left[\frac{1}{\concAtm - \conc_s} - \frac{1}{\concAtm}
                              \underbrace{
                                      - \frac{1}{\diff_{s,k}\displaystyle\sum_{j_m \neq s}\frac{\conc_{j_m}}{\diff_{s,j_m}}}
                                         }_{\text{if }k \in \{j_m\}}\right] \qquad \text{if }s \neq k \\
\uu \frac{[cm^2\,s^{-1}]}{[cm^{-3}]} 
                          & \uu = [cm^2\,s^{-1}]\left[\frac{[-]}{[cm^{-3}] - [cm^{-3}]} - \frac{[-]}{[cm^{-3}]}
                                  \underbrace{\uu
