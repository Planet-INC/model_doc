...
\begin{equationCode}{MolecularDiffusionEvaluator}
\begin{split}
\doverd{\diff_s}{\conc_k} & = \frac{\diff_s}{\displaystyle\sum_{j_m \neq s}\frac{\conc_{j_m}}{\diff_{s,j_m}}}
                                \left(\sum_{j_m \neq s}\frac{\conc_{j_m}}{\diff_{s,j_m}^2}\doverd{\diff_{s,j_m}}{\conc_k} 
                                      \underbrace{- \frac{1}{\diff_{s,k}}}_{\text{if }k \in \{j_m\}}
                                \right)
                              + \underbrace{\frac{\diff_s}{\concAtm - \conc_s}}_{\text{if } s \neq k}
\\
\uu \frac{[cm^2\,s^{-1}]}{[cm^{-3}]} & \uu =
                              \frac{[cm^{2}\,s^{-1}]}{{\left(\displaystyle\sum_{j_m \neq s}\frac{[cm^{-3}]}{[cm^2\,s^{-1}]}\right)}^2}
                                \left(\sum_{j_m \neq s}\frac{[cm^{-3}]}{[cm^2\,s^{-1}]^2}\frac{[cm^2\,s^{-1}]}{[cm^{-3}]} - \underbrace{\uu\frac{1}{[cm^2\,s^{-1}]}}_{\text{if }k \in j_m}\right) \\[5pt]
                                     & \uu\fakeequalspace +
                              \underbrace{\uu\frac{[cm^2\,s^{-1}]}{{[cm^{-3}] - [cm^{-3}]}}}_{\text{if } s \neq k} \\
\end{split}
\label{Titan:Ds_dn}
\end{equationCode}
%%
...
\begin{equationCode}{MolecularDiffusionEvaluator}
\begin{split}
\doverd{\tilde{\diff_s}}{T}    & = \doverd{\diff_s}{T} \frac{1}{1 - \frac{\conc_s}{\concAtm}\left(1 - \frac{\Mm_s}{\mean{\Mm_{\neq s}}}\right)} \\
